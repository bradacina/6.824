...
func TestReElection2A(t *testing.T) {
	...
	log.Printf("Disconnecting [%d]\n", leader1)
	cfg.disconnect(leader1)
	cfg.checkOneLeader()

	// if the old leader rejoins, that shouldn't
	// disturb the new leader.
	log.Printf("Connecting [%d]\n", leader1)
	cfg.connect(leader1)
...
func TestManyElections2A(t *testing.T) {
	...
	for ii := 1; ii < iters; ii++ {
		...
		i2 := rand.Int() % servers
		i3 := rand.Int() % servers
		log.Println("Disconnecting", i1)
		log.Println("Disconnecting", i2)
		log.Println("Disconnecting", i3)
		cfg.disconnect(i1)
		cfg.disconnect(i2)
		cfg.disconnect(i3)
		...
		log.Println("Reconnecting", i1)
		log.Println("Reconnecting", i2)
		log.Println("Reconnecting", i3)
		cfg.connect(i1)
		cfg.connect(i2)
		cfg.connect(i3)
	}
